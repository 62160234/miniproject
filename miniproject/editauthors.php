                    ...
                    <nav class="col navbar navbar-expand-lg justify-content-end">
                        ...
                        <div class="collapse navbar-collapse menu-right" id="collapsibleNavbar">
                            <ul class="navbar-nav justify-content-center w-100">
                                ...
                                <li class="nav-item">
                                    <a href="editauthors.php" class="nav-link active">ชื่อผู้เขียน : <?php echo $_SESSION['name']; ?> <span class="ti-pencil"></span></a>
                                </li>
            ...
            <div class="row">
                ...
                <form method="post" name="registform" onSubmit="return formValidation();" action="edit_profile.php">
                    ...
                    <div class="col-md-12 offset-md-left">
                        ...
                        <a href="myarticle.php">ไปยังหน้าบทความของฉัน</a>
                    </div>
                </form>
            </div>
        </div>
