...
<body>
    ...
    <section class="contact-page-area section-gap">
        ...
        <div class="container">
            ...
            <h3 class="mb-30">แก้ไขบทความ <a href="myarticle.php" class="btn btn-sm btn-primary">ไปยังหน้า: บทความของฉัน</a></h3>
                ...
                <div class="col-md-12 col-lg-12">
                    ...
                    <form method="post" action="update_article.php">
                        <div class="form-group row">
                            <label class="col-md-12 col-form-label text-md-left">ID</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            <label class="col-md-12 col-form-label text-md-left">สถานะ</label>
                            <div class="col-md-12">
                                <select name="publishSts">
                        ...
                        <div class="col-md-12 offset-md-left">
                            ...
                            &nbsp;&nbsp;
                            <button onclick="return confirm('คุณต้องการลบข้อมูลนี้ใช่หรือไม่?')" href="delete.php?id=<?php echo $row->id ?>" class="btn btn-sm btn-danger">ลบ</button>
                        </div>
                    </form>
                </div>
            </div>
